...
class ContextEncoder():
    ...
    def sample_images(self, epoch, imgs):
        ...
        for i in range(c):
            ...
            axs[2,i].axis('off')
        fig.savefig("graphs/%d.png" % epoch)
        plt.close()

    def save_model(self):

        def save(model, model_name):
            model_path = "trained/%s.json" % model_name
            weights_path = "trained/%s_weights.hdf5" % model_name
        ...
        self.generator.save("trained/generator.h5")
